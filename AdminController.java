...
public class AdminController {
    ...
    @GetMapping("/vehicles")
    public ResponseEntity<?> allVehicles() { return ResponseEntity.ok(vehicleService.getAll()); }

    @GetMapping("/maintenance")
    public ResponseEntity<?> allMaintenance() { return ResponseEntity.ok(maintenanceService.getAll()); }

    @GetMapping("/schedules")
    public ResponseEntity<?> allSchedules() { return ResponseEntity.ok(scheduleService.getAll()); }

    @GetMapping("/schedules/today")
    public ResponseEntity<?> todaySchedules() { return ResponseEntity.ok(scheduleService.getToday()); }
